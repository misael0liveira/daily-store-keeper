...
- Abertura: Android 12+ usa splash nativo claro com o logotipo completo contido na área segura da máscara do sistema; depois, a interface de abertura do app mantém a marca por cerca de quatro segundos na inicialização fria.
...
- Consulta assistida no estoque: ao ler um código ainda não cadastrado, o APK pode consultar nome, marca e embalagem na Open Food Facts pela internet. O operador revisa/edita os campos; preço e quantidade em estoque continuam manuais. Somente o código consultado é enviado. A resposta só entra no store local após salvar; falha, produto ausente ou falta de conexão mantêm o cadastro manual disponível. A interface atribui a fonte dos dados.
